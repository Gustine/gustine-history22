		...
		switch ($language_tag) {
			...
			case 'fr-CA':
				return new Collection([
					...
					"1 EVEN Traité de Rome 🇪🇺\n2 TYPE 🗓 Histoire\n2 DATE 25 MAR 1957\n2 NOTE création de la Communauté économique européenne et du Marché commun européen. René Coty est alors président de la République (1954-1959).",
					...
					"1 EVEN Loi Robert Badinter\n2 TYPE 🗓 Histoire\n2 DATE 18 SEP 1981\n2 NOTE abolition de la peine de mort en France sous la présidence (1981-1995) de François Mitterand.\n3 CONT" . $debut . "https://fr.wikipedia.org/wiki/Peine_de_mort_en_France" . $fin,
					...
					"1 EVEN Passage à l’euro 🇪🇺\n2 TYPE 🗓 Histoire\n2 DATE 01 JAN 2002\n2 NOTE les monnaies nationales (dont le franc) disparaissent dans les onze pays de la zone euro créée le 1er janvier 1999. Jacques Chirac est alors président de la République (1995-2007).\n3 CONT" . $debut . "https://fr.wikipedia.org/wiki/Euro" . $fin,
